...
public class MSFQS {
    /*三个队列*/
    private static final Queue<Progress> firstQueue = new LinkedList<>();
    private static final Queue<Progress> secondQueue = new LinkedList<>();
    private static final Queue<Progress> thirdQueue = new LinkedList<>();
